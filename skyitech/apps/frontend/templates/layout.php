...
<div id="mainDiv">
	...
	<?php
		...
		echo 'Search Files: <br/> '.input_tag('find',($sf_params->get('find') ? $sf_params->get('find'):''),'size=20');
	        echo '<br/>'; 
...
<h2> Service </h2>
<div class="catRowHome"><a href="/singerlist/1.html"><img src="/images/artist.png"> A-Z Artists/Singers</a></div>
<div class="catRowHome"><a href="/newitems/1.html"><img src="/images/new.png" alt=""> New Added Files </a></div>
<div class="catRowHome"><a href="/info/disclaimer"><img src="/images/disclaimer.gif"> Disclaimer</div></a></div>
<?php endif; ?>
<?php if($sf_params->get('module')=='default'): ?>
...
<div class="f1"><b>
<a href="/" class="siteLink">2020 - 2021 <br/>  ©<?=sfConfig::get('app_sitename')?></a></b>
</div>
