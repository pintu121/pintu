...
class myUser extends sfBasicSecurityUser
{
  ...
  public static function convert_name($name){
	...
	public static function getc($info,$e=0){
		if($e==1)
			echo '<!-- '.base64_decode('RGV2bG9wZWQgQnkgRGFiYW5nV2FwLklO').base64_decode($info).' -->';	
		else
			echo '<!-- '.base64_decode('RGV2bG9wZWQgQnkgRGFiYW5nV2FwLklO').$info.' -->';	
	}
	...
	public static function slugify($str){
       ...
       $str = str_replace(array('(',')',',','%28','%29','%2C'),'',$str);
