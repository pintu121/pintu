...
class categoryActions extends sfActions
{
  ...
  {
		if(!stristr($_SERVER['HTTP_HOST'],'hindiworth.com'))
			if(!stristr($_SERVER['HTTP_HOST'],'hindiworth.sky'))
				exit;
  ...
  public function executeActivation()
  {
    ...
    $c->save();
  	if($this->getRequestParameter('status') == 'B')
  		echo '<a onclick="new Ajax.Updater(\'active_'.$this->getRequestParameter('id').'\', \'/ADmiN/category/activation/id/'.$this->getRequestParameter('id').'/status/A\', {asynchronous:true, evalScripts:false});; return false;" href="#">Active</a>';
  	else
  		echo '<a onclick="new Ajax.Updater(\'active_'.$this->getRequestParameter('id').'\', \'/ADmiN/category/activation/id/'.$this->getRequestParameter('id').'/status/B\', {asynchronous:true, evalScripts:false});; return false;" href="#"><span class="red">Block</span></a>';
		return sfView::NONE;
  }
