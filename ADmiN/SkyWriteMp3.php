...

{
	...
	if (!empty($TagFormatsToWrite)) {
		...
		if ($tagwriter->WriteTags()) {
			...
			*/
			$goto = '/ADmiN/files/create/cid/'.$_REQUEST['cid'].'/lastFile/'.$_REQUEST['lastFile'];
	...
	echo '<script type="text/javascript"> document.title="Mp3 Tag Writer Script By DabangWap.IN"; </script>';
//	echo '<HR>';
}
?>